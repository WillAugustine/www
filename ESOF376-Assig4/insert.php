...
*/
    ...
    // Overrides global settings in php.ini
    ini_set('session.use_only_cookies', TRUE);
    ini_set('session.use_tans_sid', FALSE);

    // Sets session timeout to 20 minutes
    ...
    // Regenerates session ID if session started more than 30 min ago
    ...
    // Expires session if last request was more than 20 min ago
    ...
    // Creates personalinfo table in enrollment database
