...
* Name: Will Augustine
*
* Desctiption: PHP script to validate form for Assignment5.html
*/
...
$sql_createTable_main = "CREATE TABLE IF NOT EXISTS personalinfo (
...
$conn->query($sql_createTable_main);

$sql_createTable_shadow = "CREATE TABLE IF NOT EXISTS personalinfo_shadow (
    id VARCHAR(4) NOT NULL UNIQUE,
    name VARCHAR(25) NOT NULL,
    email VARCHAR(255),
    age INT(3),
...
$conn->query($sql_createTable_shadow);
...
if (isset($valid_id, $valid_name, $valid_email, $valid_age)) {
    ...
    if ($result == '') {
        ...
        // echo "Result: '$result'";
        if ($result == '') {
            echo "Duplicate record successfully added to shadow table!<br />";
        } else {
